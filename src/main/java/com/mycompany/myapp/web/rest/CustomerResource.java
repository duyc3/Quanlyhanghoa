    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getAgeCustomer() != null) {
                    existingCustomer.setAgeCustomer(customer.getAgeCustomer());
                }
                if (customer.getAddressCustomer() != null) {
                    existingCustomer.setAddressCustomer(customer.getAddressCustomer());
                }
                if (customer.getNumberphoneCustomer() != null) {
                    existingCustomer.setNumberphoneCustomer(customer.getNumberphoneCustomer());
                }
