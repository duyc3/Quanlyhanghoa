...
public class StaffResource {
    ...
    public ResponseEntity<Staff> partialUpdateStaff(
        ...
        Optional<Staff> result = staffRepository
            ...
            .map(existingStaff -> {
                if (staff.getNameStaff() != null) {
                    existingStaff.setNameStaff(staff.getNameStaff());
                }
                if (staff.getAgeStaff() != null) {
                    existingStaff.setAgeStaff(staff.getAgeStaff());
                }
                if (staff.getAddressStaff() != null) {
                    existingStaff.setAddressStaff(staff.getAddressStaff());
                }
                if (staff.getNumberphoneStaff() != null) {
                    existingStaff.setNumberphoneStaff(staff.getNumberphoneStaff());
                }
